...
WebUI.click(findTestObject('Object Repository/Page_VietnamCupid.com/div_Mt khu_mb2'))
...
WebUI.setText(findTestObject('Object Repository/Page_VietnamCupid.com/input_Lu tm kim di tn_savesearchas'), '**!=!**')

WebUI.click(findTestObject('Object Repository/Page_VietnamCupid.com/button_Xc nhn'))
