...
WebUI.click(findTestObject('Object Repository/Page_Lin h  VietnamCupid.com/a_Nhng Vn  Khc'))

WebUI.setText(findTestObject('Object Repository/Page_Gi yu cu  Gip  Hi Vin/input_Gi yu cu_query'), '**//*/*')

WebUI.sendKeys(findTestObject('Object Repository/Page_Gi yu cu  Gip  Hi Vin/input_Gi yu cu_query'), Keys.chord(Keys.ENTER))
